...
**⚠️ Note:** This guide is intentionally thorough to avoid breakage in legacy Windows software running under Wine. My goal was to leave nothing for the reader to have to guess at. There is a bit of informational stuff in the Appendix, which is entirely optional reading. I do recommend reading about the Wine Virtual Desktop there as it describes how you should manage your EverQuest game. Anyway I'm verbose, but I do not claim to be an expert on Linux or Wine. I struggled to find help with my EverQuest installs, and this is the culmination of the lessons I learned. I hope you find the guide useful. 
...
- After the patcher finishes patching, EverQuest will launch inside the Wine 1024×768 virtual desktop. (**the success signal for this step**).
...
- 1024×768 was chosen as the first-launch resolution to fit most monitor sizes.
...
- In terminal, cd to the EverQuest install directory: **(eq2 x 2)**
...
- Launch the EQAscendant patcher: **(eq2 x 1)**
...
- ⚠️ This is our first use of "sudo", so you'll have to enter your password after entering the following command: **(eq2 x 3)**
...
- Create the launcher .desktop file: **(eq2 x 8)**
...
- Copy the launcher from /applications to /Desktop: **(eq2 x 2)**
...
- Final Notes:
  ...
  - You can edit the eqclient.ini file with nano (default terminal based text editor for most distro)  **(eq2 x 2)**
